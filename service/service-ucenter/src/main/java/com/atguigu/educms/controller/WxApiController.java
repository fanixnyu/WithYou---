...
import com.atguigu.educms.utils.ConstantWxUtils;
import com.atguigu.educms.utils.HttpClientUtils;
...
@CrossOrigin
//@RestController 这个是@Controller+@ResponseBody 返回数据
@Controller //只是请求地址，不需要返回数据，所以用@Controller
@RequestMapping("/api/ucenter/wx")
public class WxApiController {

    @Autowired
    private UcenterMemberService ucenterMemberService;//要查数据库
